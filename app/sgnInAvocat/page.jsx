...
<div className="isolate bg-gradient-to-tr from-[#000] to-[#ff4d00] px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div className="mx-auto max-w-2xl text-center">
      <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Create An account</h2>
      <p className="mt-2 text-lg leading-8 text-black">Fill out all the fields</p>
    </div>
    <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
      ...
      <div className="mt-10">
        <button type="submit" className="block w-full rounded-md bg-main px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ">Sign In</button>
      </div>
    </form>
  </div>
  )
