...
<form className=' p-30 lg:p-[300px] bg-gradient-to-br from-[#222221] to-[#C74501]'>
  <div className="space-y-7">
    ...
    <div className="border-b border-gray-900/10 pb-12">
      <h2 className="text-base font-semibold leading-7 text-white">Please fill out this form.</h2>
      <p className="mt-1 text-sm leading-6 text-orange-600">Your information remains confidential.</p>

      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div className="sm:col-span-3">
          <label for="first-name" className="block text-sm font-medium leading-6 text-white">Fist Name</label>
          <div className="mt-2">
...
onChange={(e) => setUserPrenom(e.target.value)}
        ...
        <div className="sm:col-span-4">
          <label for="email" className="block text-sm font-medium leading-6 text-white">Password</label>
          <div className="mt-2">
        ...
        <div className="sm:col-span-4">
          <label for="email" className="block text-sm font-medium leading-6 text-white">Confirm your password</label>
          <div className="mt-2">
            <input id="email" name="email" type="password" autocomplete="email"
...
onChange={(e) => setConfirmPassword(e.target.value)}
        ...
        <div className="col-span-full">
          <label for="street-address" className="block text-sm font-medium leading-6 text-white">Birth Date</label>
          <div className="mt-2">
